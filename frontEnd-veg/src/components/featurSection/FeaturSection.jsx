...
import bg_image from "./../../assets/featured.webp";
  ...
  return (
    <section className="overflow-hidden flex justify-center items-center my-4 gap-12 px-5">
      ...
      <div className="relative bg-slate-300 rounded-lg shadow-xl overflow-hidden">
        ...
        >
          View Recipe <IoArrowForwardOutline className="text-xl" />
        </motion.button>
      </div>
      ...
      >
        ...
        >
          Explore our handpicked recipe that's perfect for any occasion.
        </motion.p>
